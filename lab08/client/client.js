...
const displayUsers = users => {
    ...
    `
    qs("#users-list").innerHTML = usersHtml;
};

const appendMessage = message => {
    let align, msgUsername;
    ...
    const messageHtml = `
    <div class="${align}">
        <strong>${msgUsername}:</strong> ${message.text}
    </div
    `;
    // Notice the += here: we're appending the message to the existing HTML
    qs("#chat").innerHTML += messageHtml;
}
